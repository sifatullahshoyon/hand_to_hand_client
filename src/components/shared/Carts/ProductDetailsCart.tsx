...
// "use client";
// import ProductGallery from "@/components/modules/Products/ProductDetails/product-gallery";
// // import ProductOptions from "@/components/modules/Products/ProductDetails/product-options";
// // import ProductSummary from "@/components/modules/Products/ProductDetails/product-summary";
// import ProductTabs from "@/components/modules/Products/ProductDetails/product-tabs";

// import { IListing } from "@/types";

// const ProductDetailsCart = ({ product }: { product: IListing }) => {
//   console.log("product details cart : 144 =>", product);
//   return (
//     <>
